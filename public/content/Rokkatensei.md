...
<div style="margin-left: 3.5rem;"><h2 id="pitch" style="font-size: 2rem; color: #007bff; margin-bottom: 1.5rem;">💎 Pitch</h2>
        <p style="margin-bottom: -1rem;">
            The gate between the world of the deads and the livings has been torned down, as the ancient demons rised again in the world of the livings.
        </p>
        <p style="margin-bottom: -1rem;">
            As a great Warlord, it's your job to lead the most dauntless warriors to send back the deads where they belong.
        </p>
        <p style="margin-bottom: 2rem;">
            That would have been the plan, if you're soldiers didn't attacked like they want to.
        </p></div>
...
<div id="introduction" style="display: flex; align-items: flex-start; gap: 2rem; margin: 2rem 0; max-width: 1200px; margin-left: auto; margin-right: auto;">
    <div style="flex: 1; padding: 0 15px; color: #fff; text-align: justify; line-height: 1.6; max-width: 600px;">
        ...
        <p style="margin-bottom: 0rem;">
            <i>Rokkatensei</i> is a mobile turn based fighting game. In a asian and Samurai themed game, monsters representing divinity or fantasy like Oni, Kappa, etc.. And allies being Samurai, monks, etc.. 
        </p>
        <p style="margin-bottom: 2rem;">
            Each characters, enemies or allies have different abilities and way to fight or defend themselves, some pushing, some others doing area effects, etc..
        </p>
        <p style="margin-bottom: 1.2rem;">
            We made the game as a school project to try the mobile game type, additionally to that we try a turn based fighting game, it was really fun to make even tho we were all beginners with no knowledge of both mobile and turn based fight games.
        </p>
        <p>
