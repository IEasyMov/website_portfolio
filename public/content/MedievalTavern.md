...
<div style="margin-left: 3.5rem;"><h2 id="pitch" style="font-size: 2rem; color: #007bff; margin-bottom: 1.5rem;">💎 Pitch</h2>
        <p style="margin-bottom: -1rem;">
            Oy oyyy, I see that you're new in town, right? There is an awf- Beautiful Tavern that you could try to get back on wheels
        </p>
        <p style="margin-bottom: 2rem;">
            Grab that broom and thoses beers, make it shine and make it the beauty of the city like back in the days!
        </p></div>
...
<div id="introduction" style="display: flex; align-items: flex-start; gap: 2rem; margin: 2rem 0; max-width: 1200px; margin-left: auto; margin-right: auto;">
    <div style="flex: 1; padding: 0 15px; color: #fff; text-align: justify; line-height: 1.6; max-width: 600px;">
        ...
        <p style="margin-bottom: 2rem;">
            <i>Medieval Tavern</i> is a little protype where the player is basicly the owner of a dirty and old tavern, customers will enter and ask for drink and food, while you will have to refill your stocks of alcohol and ingredients, manage your tables, receive and prices and clean the building to satisfy the clients!
        </p>
        <p style="margin-bottom: 1.2rem;">
            This game is basicly a sandbox / try prototype that I absolutly wanted to make, I had this idea stuck in my head and as a Game Designer I was getting super frustrated not being able to create my own protos and games, so I decided to open Unity and start that sandbox of a prototype myself.
        </p>
        <p>
            My Objectives for the project were to learn basic C# to be able to make my own protos and ideas, learn how to use blockout and 3D assets, implement sound design as well as animate with the Unity Animator, and Mixamo.
        </p>
    </div>
