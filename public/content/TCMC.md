...
<div id="introduction" style="display: flex; align-items: flex-start; gap: 2rem; margin: 2rem 0; max-width: 1200px; margin-left: auto; margin-right: auto;">
    <div style="flex: 1; padding: 0 15px; color: #fff; text-align: justify; line-height: 1.6; max-width: 600px;">
        ...
        <p style="margin-bottom: 2rem;">
            <i>The Cryptic Mutation Conundrum</i> is a puzzle game where the player.. Playing as a children with surnatural powers, will have to face different rooms with puzzles and enigmas.. Among the kids drawings and toys in the room there will be clues and hits to help him escape this laboratory.
        </p>
        <p style="margin-bottom: 1.2rem;">
            This project was our first try on Unreal Engine (4), it was quite stressful since as a Game Designer I had no idea of how the blueprints were working so even tho I wanted to help the programmers by creating some little protos, It took a while before I was actually able to craft some things myself.
        </p>
        <p>
            For this project particularly, my objectives were to get more used to Unreal Engine in general, it was also our first 3D game so prototyping in it with blockout and schematics were important for me to learn.
        </p>
    </div>
