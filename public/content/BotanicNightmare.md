...
<div style="margin-left: 3.5rem;"><h2 id="pitch" style="font-size: 2rem; color: #007bff; margin-bottom: 1.5rem;">💎 Theme & Game</h2>
        <p style="margin-bottom: -1rem;">
            The theme for this game jam was "Living Machine".
        </p>
        <p style="margin-bottom: -1rem;">I made this little game in around 18 hours, it was a very quick project and by doing it solo I had to multitask a lot, was pretty intense for a weekend.
        </p></div>
...
<div id="infos" style="display: flex; align-items: flex-start; gap: 2rem; margin: 2rem 0; max-width: 1200px; margin-left: auto; margin-right: auto;">
    <div style="color: fff; text-align: justify; line-height: 1.6;">
        ...
        <p style="margin-bottom: 2rem;">
            Project made in 18 hours on Unity 
        </p>
        <p style="margin-bottom: 1rem;">I game was made in Solo</p>
        <p style="margin-bottom: 2rem;">The game is playable from it's page Itch available below, feel free to test it!</p>
        </div>
    </div>
</div>