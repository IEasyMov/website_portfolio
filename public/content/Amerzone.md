...
<div id="introduction" style="display: flex; align-items: flex-start; gap: 2rem; margin: 2rem 0; max-width: 1200px; margin-left: auto; margin-right: auto;">
    <div style="flex: 1; padding: 0 15px; color: #fff; text-align: justify; line-height: 1.6; max-width: 600px;">
        ...
        <p style="margin-bottom: 2rem;">
            <i>L'Amerzone</i> The Explorer's Testament is a true call to travel, a dreamlike quest that transports players into a strange world filled with enigmas, where nature has reclaimed its rights.
        </p>
        <p style="margin-bottom: -1rem;">
        ...
        <p style="margin-bottom: -1rem;">
            I work on this project for few weeks only during my Internship at Microïds Studio Paris (MSP), I had no particular objective as amazed I was from the game and universe, I wanted to discover and explore it. 
        </p>
